...
- MCP integration: initialization/tool discovery, five tool calls, redacted outputs, preserved comparison facts, denied payment bypass, and persisted disclosure events passed.
- Privacy additions: 4 deterministic redaction tests and 3 local-model span-decoder tests pass. Model weights and inference remain untested.
